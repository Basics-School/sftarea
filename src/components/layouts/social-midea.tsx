...
export const socialMediaProfiles = [
    {
        title: 'Facebook',
        href: 'https://facebook.com/iTechHarbourAgency',
        icon: FacebookIcon,
    },
    {
        title: 'Instagram',
        href: 'https://instagram.com/itechharbour',
        icon: InstagramIcon,
    },
    { title: 'Twitter', href: 'https://x.com/iTechHarbour', icon: TwitterIcon },
    {
        title: 'LinkedIn',
        href: 'https://www.linkedin.com/company/itechharbour/',
        icon: LinkedInIcon,
    },
]
        ...
        >
            {socialMediaProfiles.map((socialMediaProfile) => (
                <li key={socialMediaProfile.title}>
                    ...
                    >
                        <socialMediaProfile.icon className="h-6 w-6 fill-current text-background" />
                    </Link>
                </li>
            ))}
        </ul>
